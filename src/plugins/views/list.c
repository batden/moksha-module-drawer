...
static void _list_entry_select_cb(void *data, Evas_Object *obj, const char *emission __UNUSED__,
                                  const char *source __UNUSED__);
static void _list_entry_deselect_cb(void *data, Evas_Object *obj, const char *emission __UNUSED__,
                                    const char *source __UNUSED__);
static void _list_entry_activate_cb(void *data, Evas_Object *obj, const char *emission __UNUSED__,
                                    const char *source __UNUSED__);
static void _list_entry_context_cb(void *data, Evas_Object *obj, const char *emission __UNUSED__,
                                   const char *source __UNUSED__);
...
_list_autoscroll_update(Instance *inst, Evas_Coord x, Evas_Coord y, Evas_Coord w, Evas_Coord h)
{
   ...
   if (!inst->scroll_timer)
      inst->scroll_timer = ecore_timer_add(0.01, _list_scroll_timer, inst);
   if (!inst->scroll_animator)
      inst->scroll_animator = ecore_animator_add(_list_scroll_animator, inst);
